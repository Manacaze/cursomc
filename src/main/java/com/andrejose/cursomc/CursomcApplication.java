...
import com.andrejose.cursomc.domain.ItemPedido;
...
import com.andrejose.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Mobilia");
		Categoria cat4 = new Categoria(null, "Acessorios");
		Categoria cat5 = new Categoria(null, "Churasco");
		Categoria cat6 = new Categoria(null, "Livraria");
		Categoria cat7 = new Categoria(null, "Clube");
		Categoria cat8 = new Categoria(null, "Sexy Toys");
