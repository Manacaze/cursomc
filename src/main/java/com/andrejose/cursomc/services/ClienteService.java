...
import com.andrejose.cursomc.dto.ClienteDTO;
import com.andrejose.cursomc.dto.ClienteNewDTO;
import com.andrejose.cursomc.repositories.ClienteRepository;
import com.andrejose.cursomc.repositories.EnderecoRepository;
import com.andrejose.cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public Cliente find(Integer id) {
		Optional<Cliente> object = repo.findById(id);
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getCpf(), TipoCliente.toEnum(objDto.getTipoCliente()));
